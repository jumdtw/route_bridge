...
int chackIPchecksum(struct iphdr *iphdr,unsigned char *option,int optionLen);
int SendArpRequwstB(int soc,in_addr_t target_ip,unsigned char target_mac[6],in_addr_t my_ip,unsigned char my_mac[6]);